...
btnSign.onclick=function(){
  ...
  let queryBest = "INSERT INTO user (username,pass) VALUES ('" + newUsername + "', '" + newPassword + "')"
       req2 = Ajax("https://ormond.creighton.edu/courses/375/ajax-connection.php", "POST", "host=ormond.creighton.edu&user=aec83928&pass=" + pw + "&database=aec83928&query=" +  query)     
              ...
              if (results1.length > 0) {
                lblVerified.value = "Please choose another username"
                    ...
                    lblVerified.value = "Verified password needs to match"
                                              ...
                                              req4 = Ajax("https://ormond.creighton.edu/courses/375/ajax-connection.php", "POST", "host=ormond.creighton.edu&user=aec83928&pass=" + pw + "&database=aec83928&query=" +  query)    
