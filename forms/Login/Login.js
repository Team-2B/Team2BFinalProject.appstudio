...
btnLogin.onclick=function(){
   let checkPassword = inptPassword.value
    ...
    req1 = Ajax("https://ormond.creighton.edu/courses/375/ajax-connection.php", "POST", "host=ormond.creighton.edu&user=aec83928&pass=" + pw + "&database=aec83928&query=" +  query)  
    if (req1.status == 200) { //everything worked.
        ...
        if (results.length == 0)  //there is no user or the password was entered incorrectly
            lblResult.value = "Incorrect username or password"
              ...
              //req6 = Ajax("https://ormond.creighton.edu/courses/375/ajax-connection.php", "POST", "host=ormond.creighton.edu&user=aec83928&pass" + pw + "!&database=aec83928&query=" +  queryCurrentUser)
